...
//====================================================
#define	EZEX_NAND_BBT	1

#define	NAND_SIZE		0x08000000
#define	NAND_BLOCK		0x20000
#define	SIZ_1M			0x100000
#define	BBT_SIZE		2*SIZ_1M
#define	BBT_NAND_ADDR	(0xc3e00000 - NAND_BLOCK)
#define	BBT_0_ADDR		(NAND_SIZE - BBT_SIZE)
#define	BBT_1_ADDR		(BBT_0_ADDR + NAND_BLOCK)
#define	BBT_START_ADDR	(BBT_1_ADDR + NAND_BLOCK)
#define	MAX_BBT_TBL		((BBT_SIZE / NAND_BLOCK) - 2)
#define	BBT_MARK		0x58455A45	// "EZEX"
#define	BBT_MARK_1		0x54424220	// " BBT"

#define	BBT_NOT_FOUND	0
#define	BBT_FOUND		1
#define	BBT_ERROR		2
//====================================================
...
#define	CONFIG_DM9000_BASE		(0x08000000)	//0x16000000
...
#if 1	// ben environment
#define CONFIG_IPADDR		192.168.0.10
#define CONFIG_SERVERIP		192.168.0.5
#define CONFIG_GATEWAYIP	192.168.0.1
#else	// junny environment
#define CONFIG_IPADDR		192.168.2.42
#define CONFIG_SERVERIP		192.168.2.151
...
#define	CFG_PROMPT		"eZEX IHD # "	/* Monitor Command Prompt	*/
...
#define	CFG_BANK_CFG_VAL		0x00049253		//0x0004920d
#define	CFG_BANK_CON1_VAL		0x44000040		//0x04000040
...
#define	CFG_BANK_CON2_VAL		0x005D003a		//0x0057003a
...
#if	EZEX_NAND_BBT
#define CONFIG_BOOTCOMMAND	"nand read c0008000 40000 200000;bootm c0008000"
#define CONFIG_EBOOTCOMMAND	"nand read c0008000 4600000 200000;bootm c0008000"
#define CONFIG_UPDKERNEL	"tftp c0000000 f-zImage;nand erase 40000 200000;nand write c0000000 40000 200000;tftp c0000000 f-zImage-ext;nand erase 4600000 200000;nand write c0000000 4600000 200000"
#define CONFIG_UPDKERNEL1	"tftp c0000000 f-zImage;nand erase 40000 200000;nand write c0000000 40000 200000"
#define CONFIG_UPDKERNEL2	"tftp c0000000 f-zImage-ext;nand erase 4600000 200000;nand write c0000000 4600000 200000"
#define CONFIG_UPDROOT		"tftp c0000000 f-rf.cramfs;nand erase 440000 9c0000;nand write c0000000 440000 9c0000;nand erase 4800000 a00000;nand write c0000000 4800000 a00000"
#define CONFIG_UPDUSER		"tftp c0000000 f-uf.cramfs;nand erase 5200000 e00000;nand write c0000000 5200000 e00000"
#define CONFIG_UPDBOOT		"tftp c0000000 f-u-boot.bin;nand erase 0 3c000;nand write c0000000 0 3c000"
#else
#define CONFIG_BOOTCOMMAND	"nand read c0008000 40000 200000;bootm c0008000"
#define CONFIG_EBOOTCOMMAND	"nand read c0008000 4600000 200000;bootm c0008000"
#define CONFIG_UPDKERNEL	"tftp c0000000 zImage;nand erase 40000 200000;nand write c0000000 40000 200000;tftp c0000000 zImage-ext;nand erase 4600000 200000;nand write c0000000 4600000 200000"
#define CONFIG_UPDKERNEL1	"tftp c0000000 zImage;nand erase 40000 200000;nand write c0000000 40000 200000"
#define CONFIG_UPDKERNEL2	"tftp c0000000 zImage-ext;nand erase 4600000 200000;nand write c0000000 4600000 200000"
#define CONFIG_UPDROOT		"tftp c0000000 rf.cramfs;nand erase 440000 9c0000;nand write c0000000 440000 9c0000;nand erase 4800000 a00000;nand write c0000000 4800000 a00000"
#define CONFIG_UPDUSER		"tftp c0000000 uf.cramfs;nand erase 5200000 e00000;nand write c0000000 5200000 e00000"
#define CONFIG_UPDBOOT		"tftp c0000000 u-boot.bin;nand erase 0 3c000;nand write c0000000 0 3c000"
#endif
#define CONFIG_MEMFILL		"mw c0000000 ffffffff 800000"
